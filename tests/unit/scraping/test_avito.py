...
@pytest.mark.vcr()
@pytest.mark.parametrize(
    "url, expected", [(test["url"], test["header"]) for test in AVITO_ANNOUNCEMENTS]
)
...
@pytest.mark.vcr()
@pytest.mark.parametrize(
    "url, expected", [(test["url"], test["attributes"]) for test in AVITO_ANNOUNCEMENTS]
)
...
@pytest.mark.vcr()
@pytest.mark.parametrize(
    "url, expected", [(test["url"], test["equipments"]) for test in AVITO_ANNOUNCEMENTS]
)
