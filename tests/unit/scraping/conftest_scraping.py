...
AVITO_ANNOUNCEMENT_REQUIRED_ONLY = {
    ...
    "attributes": {'Type': 'Appartements, à vendre', 'Secteur': 'Toute la ville', 'Surface habitable': '1', 'Étage': '1'},
    "equipments": []
}
...
AVITO_ANNOUNCEMENT_NO_EQUIPMENTS = {
    ...
    "attributes": {'Type': 'Appartements, à vendre', 'Secteur': 'Oulfa', 'Frais de syndic / mois': '30', 'Salons': '1', 'Surface habitable': '50', 'Âge du bien': '1-5 ans', 'Étage': '3'},
    "equipments": []
}
